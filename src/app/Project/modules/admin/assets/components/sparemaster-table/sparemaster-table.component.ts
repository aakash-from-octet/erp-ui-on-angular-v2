...
@Component({
  selector: 'app-sparemaster-table',
  templateUrl: './sparemaster-table.component.html',
  styleUrls: ['./sparemaster-table.component.css'],
})
export class SparemasterTableComponent implements OnInit{
  checked = false;
  loading = false;
  indeterminate = false;
  listOfData: Data[] = [];
