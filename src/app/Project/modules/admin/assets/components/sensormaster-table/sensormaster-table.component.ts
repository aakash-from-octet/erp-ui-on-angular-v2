...
@Component({
  selector: 'app-sensormaster-table',
  templateUrl: './sensormaster-table.component.html',
  styleUrls: ['./sensormaster-table.component.css'],
})
export class SensormasterTableComponent implements OnInit{
  checked = false;
  loading = false;
  indeterminate = false;
  listOfData: Data[] = [];
