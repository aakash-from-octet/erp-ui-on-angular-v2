...
@Component({
  selector: 'app-sparemaster-main-page',
  templateUrl: './sparemaster-main-page.component.html',
  styleUrls: ['./sparemaster-main-page.component.css'],
})
export class SparemasterMainPageComponent implements OnInit {
  isVisible = false;
