...
@Component({
  selector: 'app-taskgroup-main-page',
  templateUrl: './taskgroup-main-page.component.html',
  styleUrls: ['./taskgroup-main-page.component.css'],
})
export class TaskgroupMainPageComponent implements OnInit {
  isVisible = false;
