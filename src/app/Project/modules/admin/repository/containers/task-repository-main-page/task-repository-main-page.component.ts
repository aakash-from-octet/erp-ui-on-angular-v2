...
@Component({
  selector: 'app-task-repository-main-page',
  templateUrl: './task-repository-main-page.component.html',
  styleUrls: ['./task-repository-main-page.component.css'],
})
export class TaskrepositoryMainPageComponent implements OnInit {
  isVisible = false;
