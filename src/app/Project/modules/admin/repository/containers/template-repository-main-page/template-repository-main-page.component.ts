...
@Component({
  selector: 'app-template-repository-main-page',
  templateUrl: './template-repository-main-page.component.html',
  styleUrls: ['./template-repository-main-page.component.css'],
})
export class TemplateRepositoryMainPageComponent implements OnInit {
  isVisible = false;
  ...
  createNotification(type: string): void {
    this.notification.create(type, 'Template Created Successfully!', '', {
