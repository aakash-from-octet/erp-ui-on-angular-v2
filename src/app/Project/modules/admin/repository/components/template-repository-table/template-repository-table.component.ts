...
@Component({
  selector: 'app-template-repository-table',
  templateUrl: './template-repository-table.component.html',
  styleUrls: ['./template-repository-table.component.css'],
})
export class TemplaterepositoryTableComponent implements OnInit {
  checked = false;
  loading = false;
  indeterminate = false;
  listOfData: Data[] = [];
