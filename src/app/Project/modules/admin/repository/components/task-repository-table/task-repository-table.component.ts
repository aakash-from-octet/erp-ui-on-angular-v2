...
@Component({
  selector: 'app-task-repository-table',
  templateUrl: './task-repository-table.component.html',
  styleUrls: ['./task-repository-table.component.css'],
})
export class TaskrepositoryTableComponent implements OnInit {
  checked = false;
  loading = false;
  indeterminate = false;
  listOfData: Data[] = [];
